/*
    * @file hashtable.h
    * @brief A simple hash table implementation for Arduino.
    * 
    * @note This file is a modified version of the ArduinoHashtable library.
    * Original library can be found here: https://github.com/braydenanderson2014/ArduinoHashtable
*/
#ifndef HASHTABLE_H
#define HASHTABLE_H
        ...
        */
        ...
        SimpleVector<K> getKeys() {
            ...
            for (int i = 0; i < this->TABLE_SIZE; ++i) {
                for (Entry* entry = this->table[i]; entry != nullptr; entry = entry->next) {
                    keys.put(entry->key);
                }
            }
            return keys;
